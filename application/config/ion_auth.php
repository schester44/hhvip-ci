 ...
 */
$config['site_title']                 = "hiphopVIP";       // Site Title, example.com
$config['admin_email']                = "contact@hiphopvip.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['moderator_group']            = 'moderator';             // Default administrators group, use name
