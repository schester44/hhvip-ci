      ...
      <?php $this->load->view('user/header'); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <article class="entry style-single type-post">
                        ...
                        <div style="text-align:center;font-size:18px;">You don't have any followers yet!</div>
                        <?php } else { ?>
                        <div style="text-align:center;font-size:18px;">No one follows this person, yet!
                            Be The First.</div>
                          <?php } // user
                          } //else ?>
                        </ul>
