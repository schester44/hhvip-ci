...
<head>
    ...
    <title><?php echo htmlspecialchars($playlist->title, ENT_QUOTES) . ' Playlist by ' . $playlist->username . ' ' . $this->lang->line('meta_title');; ?></title>
...
<body>
 ...
 <!-- BEGIN Player Container -->
        ...
        <div id="mixtape-share-details" class="shembed">Click to share:<br />
            <div class="social-likes" style="margin-top:-2px" data-url="<?php echo base_url('playlist/'.$playlist->username.'/'.$playlist->url) ?>">
                <div class="facebook" title="Share link on Facebook">Facebook</div>
                <div class="twitter" data-via="hiphopvip1" data-related="<?php echo htmlspecialchars($playlist->title, ENT_QUOTES); ?> Playlist" title="Share link on Twitter">Twitter</div>
            </div>

        </div>
        <div id="mixtape-embed-details" class="shembed">
            Copy and paste the following code to display the player on your website.
            <textarea class="embed-text" onclick="this.focus();this.select()" id="shemed" style>&lt;iframe src="<?php echo base_url( 'embed/playlist/1/'.$playlist->username.'/'.$playlist->url) ?>" scrolling="no" width="100%" height="325px" scrollbars="no" frameborder="0"&gt;&lt;/iframe&gt;</textarea>
        </div>
